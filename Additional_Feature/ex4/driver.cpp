...
// solution inspired from http://courses.washington.edu/css503/prog/prog2.pdf
using namespace std;
...
int main( int argc, char *argv[] ) {
  int nBarbers = 3;      // # barbers working in the barbershop
  int nChairs = 6;       // # chairs available for customers to wait on
  int nCustomers = 20;    // # customers who need a haircut service
  int serviceTime = 1000;   // each barber's service time ( in u seconds)
