default:	
	gcc -pthread -o	./1_MakingBread/main.o ./1_MakingBread/cli.c ./1_MakingBread/ExclAccInv.o ./1_MakingBread/BinTreeInv.o ./1_MakingBread/RecipeBook.o && make precompile
